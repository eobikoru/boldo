    ...
    <section className="py-12 md:py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-10 max-w-6xl mx-auto">
          {/* Feature Card 1 */}
          <div className="flex  flex-col md:w-[85%] items-start">
            ...
            <Link
              href="#"
              className="inline-flex items-center font-bold border-b pb-4 border-gray-900 pb-1 hover:text-gray-700 transition-colors text-black"
            >
              Explore page <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </div>
          ...
          <div className="flex flex-col md:w-[85%] items-start">
            ...
            <Link
              href="#"
              className="inline-flex items-center pb-4 font-bold border-b border-gray-900 pb-1 hover:text-gray-700 transition-colors text-black"
            >
              Explore page <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </div>
          ...
          {/* Feature Card 3 */}
          <div className="flex md:w-[85%] flex-col items-start sm:col-span-2 md:col-span-1">
            <div className="w-full mb-6">
              <Image
                src="/assests/images/ill3.png"
                alt="Person sitting by buildings"
