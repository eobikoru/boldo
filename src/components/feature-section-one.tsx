      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="relative mb-16 md:mb-0">
            ...
            <div className="hidden md:flex absolute flex-col items-center bottom-0 left-[22rem] -translate-x-1/2 translate-y-1/4 bg-white p-4 md:p-6 rounded-lg shadow-lg w-56 md:w-64">
            ...
            <div className="md:hidden flex flex-col items-center bg-white p-4 rounded-lg shadow-lg mx-auto -mt-10 relative z-10 w-56">
          ...
          <div>
            ...
            <button className="mt-8 md:mt-10 bg-[#0A1930] text-white px-10 md:px-16 py-2.5 md:py-3 rounded-full font-medium hover:bg-opacity-90 transition-colors">
              Start now
            </button>
          </div>
        </div>
